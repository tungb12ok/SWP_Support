                        ...
                        <form action="profile" method="POST">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" placeholder="enter address line 1" name="address" value="Ha Noi">
                                </div>
                                <div class="col-md-12">
                                    <label class="labels">User Type</label>
                                    <input type="" class="form-control" placeholder="education" name="userType" value="${user.getUserType()}" readonly="">
                                </div>
                            </div>
